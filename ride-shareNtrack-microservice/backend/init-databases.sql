...
CREATE USER auth_user WITH ENCRYPTED PASSWORD 'auth_password' CREATEDB;
CREATE USER user_user WITH ENCRYPTED PASSWORD 'user_password' CREATEDB;
CREATE USER ride_user WITH ENCRYPTED PASSWORD 'ride_password' CREATEDB;
CREATE USER location_user WITH ENCRYPTED PASSWORD 'location_password' CREATEDB;
CREATE USER notification_user WITH ENCRYPTED PASSWORD 'notification_password' CREATEDB;
CREATE USER payment_user WITH ENCRYPTED PASSWORD 'payment_password' CREATEDB;
CREATE USER recomendation_user WITH ENCRYPTED PASSWORD 'recomendation_password' CREATEDB;
CREATE USER shared_user WITH ENCRYPTED PASSWORD 'shared_password' CREATEDB;
